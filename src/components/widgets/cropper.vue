<template>
  <div
    v-if="!localCroppedImageUrl && !localImageUrl"
    class="dropzone"
  ...
  <div v-if="localCroppedImageUrl || localImageUrl" class="preview d-flex">
    <div class="delete-button" @click="clearCroppedImage">
      <BButton class="btn btn-sm btn-danger"
        ><i class="mdi mdi-delete-outline"></i
      ></BButton>
    </div>
    <img :src="localCroppedImageUrl || localImageUrl" alt="Cropped Image" class="mx-auto" />
  </div>
</template>
